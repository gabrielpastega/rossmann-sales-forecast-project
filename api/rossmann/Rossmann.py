...
class Rossmann(object):
    def __init__(self):
        self.home_path='/home/gabrielpastega/repos/ds_em_producao/dsemproducao/'
    ...
    def data_preparation(self, df3):
        ...
        ## RESCALING
        # competition_distance
        df3['competition_distance'] = self.competition_distance_scaler.transform(df3[['competition_distance']].values)
        
        # competition_time_month
        df3['competition_time_month'] = self.competition_time_month_scaler.transform(df3[['competition_time_month']].values)
        
        # promo_time_week
        df3['promo_time_week'] = self.promo_time_week_scaler.transform(df3[['promo_time_week']].values)
